import { Code, Database, BarChart3, Brain, Globe, Users, Clock, Target, MessageCircle, CheckCircle, Crown, Lightbulb } from 'lucide-react';
const Skills = () => {
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 animate-slide-up">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {technicalSkills.map((skill, index) => <div key={index} className="bg-card p-5 rounded-lg shadow-card hover-lift">
            ...
            <div className="space-y-12 animate-slide-up">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {softSkills.map((skill, index) => <div key={index} className="bg-card p-4 rounded-lg shadow-card hover-lift">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {languages.map((language, index) => <div key={index} className="bg-card p-4 rounded-lg shadow-card hover-lift">
